...
\begin{lemma}    
Let $\set{\cP_i}_{i=1}^n$ and $\set{\cQ_i}_{i=1}^n$ be distributions over $n$-tuples.
Moreover, we assume
\begin{itemize}
...
and completion/coupling lemmas \Ethan{Commented out below, find a home for it at some point} that turn TVD bounds into additive-error judgments over SSProve semantics.
