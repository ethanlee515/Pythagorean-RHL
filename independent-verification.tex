...
effort.
\Cref{tab:artifact-map} separates the application-specific security argument
...
The top-level result is a functor over precisely the five interfaces in
\Cref{tab:theorem-boundary}; probability lemmas and program rules are proved
dependencies, not additional functor parameters.
...
The scheme, chart, correctness, parameter, and IND-CPA facts in
