...
\end{enumerate}
\Cref{sec:pyth-toolkit} constructs this bridge from a Pythagorean judgment,
unary invariant proofs, and a trace compiler, proves its soundness
independently of FHE, and then applies it to derive the paid arrow in
