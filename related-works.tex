...
it machine-checks an existing reduction and the square-root
...
adding judgments and a selected-call compiler.
Recent
...
Adversary are treated as opaque modules, and reflection techniques \cite{reflection}
can be used to extract the adversary's semantics.
...
replacement theorem is applied.
