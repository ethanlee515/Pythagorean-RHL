...
The artifact contains 27,987 lines of Rocq.
Since a majority of the codebase was written with AI,
this line count is not an accurate reflection of our engineering effort.
...
upstream unproven lemma ~\cite{ssprove}.  This is an inherited assumption, not an
...
\ifdefined\CameraReady
via \href{https://github.com/math-comp/analysis/pull/2007}%
{\texttt{math-comp/analysis\#2007}},
\fi
for inclusion in the 1.17.0 release.
Before this patch eventually reaches SSProve,
\texttt{Print Assumptions} for the top-level theorem
will continue to display the admitted lemma.
