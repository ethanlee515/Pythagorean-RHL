...
\inferrule*[right=\textsc{Shared-Prefix}] {\vDash\mathsf{Hoare}\{P_0\}\ c\ \{M\} \\ \vDash\Pyth\{M^{=}\}\ k_L\approx_s k_R\ \{Q\}} {\vDash\Pyth\{P\}\ (x\leftarrow c;k_L(x)) \approx_{[0]\doubleplus s} (x\leftarrow c;k_R(x))\ \{Q\}}
