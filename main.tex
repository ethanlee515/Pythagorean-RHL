...
\title{Verified Pythagorean Composition for \\ Adaptive Cryptographic Games:\\
\huge{Noise Flooding in Homomorphic Encryption}}

\ifdefined\CameraReady
\author{%
  \IEEEauthorblockN{Yi Lee\IEEEauthorrefmark{1},
    Alexandru Cojocaru\IEEEauthorrefmark{2},
    Junyi Liu\IEEEauthorrefmark{1}, and
    Xiaodi Wu\IEEEauthorrefmark{1}}
  \IEEEauthorblockA{%
    \IEEEauthorrefmark{1}Joint Center for Quantum Information and Computer Science,
    University of Maryland, USA\\
    \IEEEauthorrefmark{2}School of Informatics, The University of Edinburgh,
    United Kingdom\\
    \url{ylee1228@umd.edu}, \url{a.cojocaru@ed.ac.uk},
    \url{junyiliu@umd.edu}, \url{xwu@cs.umd.edu}}}
\else
...
\Ethan{There is a ``CameraReady'' switch in ``macros.tex'' for displaying author names and affiliations}
