...
\title{Machine-Checked Noise-Flooding Security\\ for Adaptive Decryption Queries}
...
We give a machine-checked, game-based account of this argument in Rocq and SSProve.
For an abstract approximate-FHE scheme satisfying explicit metric,
probability-one correctness, and IND-CPA assumptions, the development
constructs a reduction for every \(q\)-query IND-CPAD adversary and proves
...
multiplier.
The proof constructs a new relational program logic
...
\input{appendix-ssprove-semantics}
