...
\title{Formal Verification of Noise Flooding Analysis in Homomorphic Encryption}
...
\Alex{I added an alternative intro in the alternative intro commented below. But feel free to use whichever version looks better.}
\input{alternative_intro_alex}
