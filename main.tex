...
support-correctness, and IND-CPA assumptions, the development constructs a
reduction for every \(q\)-query IND-CPAD adversary and proves
...
multiplier.  The proof constructs a new relational program logic
over SSProve semantics.  Its Pythagorean judgment composes
...
required discrete-Gaussian analysis.  The checked theorem
