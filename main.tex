...
For an abstract approximate-FHE scheme satisfying explicit metric, support-correctness, and IND-CPA assumptions, the development constructs a reduction for every \(q\)-query IND-CPAD adversary and proves
